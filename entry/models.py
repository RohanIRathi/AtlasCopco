...
class User(models.Model):  # the user model includes the admin, employee and security guard
    username = models.CharField(max_length=200, validators=[
        MinLengthValidator(4, "Minimum 4 characters are required"), ])  # username for login, can be same as the email
    email = models.EmailField()  # email for registration
    mobile = models.CharField(max_length=10, validators=[MinLengthValidator(10, 'Enter a 10 digit mobile number'),
                                                         MaxLengthValidator(10)])  # mobile no for registration
    ...
    password = models.CharField(max_length=128, default='',
                                validators=[MinLengthValidator(6, "Password must contain atleast 6 characters")])
...
class Visitor(models.Model):
    ...
    mobile = models.IntegerField(validators=[MinLengthValidator(10, 'Enter a 10 digit mobile number'),
                                             MaxLengthValidator(10)])  # mobile no. of the visitor
