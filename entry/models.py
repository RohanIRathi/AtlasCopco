...
from django.core.validators import EmailValidator, MinLengthValidator, MaxValueValidator, MinValueValidator
...
class Visitor(models.Model):
	...
	mobile = models.BigIntegerField(verbose_name='Mobile number', validators=[MinValueValidator(1000000000),MaxValueValidator(9999999999)])  # mobile no. of the visitor
